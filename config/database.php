    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => _env('DATABASE_URL'),
            'host' => _env('DB_HOST', '141.136.39.100'),
            'port' => _env('DB_PORT', '3306'),
            'database' => _env('DB_DATABASE', 'financea_PRESTAMOS_WEB'),
            'username' => _env('DB_USERNAME', 'financea_dairo'),
            'password' => _env('DB_PASSWORD', 'Eliette2023.'),
        ...
        'local' => [
            ...
            'port' => _env('DB_PORT', '3306'),
            'database' => _env('DB_DATABASE', 'prestamos_web'),
            'username' => _env('DB_USERNAME', 'root'),
            'password' => _env('DB_PASSWORD', 'asd'),
            'unix_socket' => _env('DB_SOCKET', ''),
            'charset' => _env('DB_CHARSET', 'utf8mb4'),
            'collation' => _env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
